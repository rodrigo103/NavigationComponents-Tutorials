...
class DashboardFragment22 : BaseDataBindingFragment<FragmentDashboard2Binding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dataBinding.btnGoToStart.setOnClickListener {
            findNavController().popBackStack(R.id.dashboardFragment11, true)
            findNavController().navigate(R.id.dashboardFragment11)
        }
